$(document).ready(function() {
  ...
  function adjustSection() {
    ...
    if (current == 1) {
      ...
      if (siblings == 1) {
      distanceToMove = ($('.active').outerHeight(true) / 0.9);
      } else {
      distanceToMove = ($('.active').outerHeight(true) / 1.1);
      }
  ...
  function moveDown() {
    ...
    if ($('.primary-navigation').hasClass('active')) {
      ...
      } else if (current == total && $('.carousel.active').hasClass('nav')) {
  ...
  function goBack() {
    ...
    } else if ($('.secondary-navigation .nav.carousel').hasClass('active')) {

      //remove active state from secondary navigation
      $('.active').removeClass('active');
